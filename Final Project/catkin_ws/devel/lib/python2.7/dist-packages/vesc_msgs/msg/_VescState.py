...
class VescState(genpy.Message):
  _md5sum = "e6d0690b6e2b538a8d1d91e427b48761"
...
"""
  ...
  __slots__ = ['voltage_input','temperature_pcb','current_motor','current_input','current_q','speed','duty_cycle','charge_drawn','charge_regen','energy_drawn','energy_regen','displacement','distance_traveled','fault_code']
  _slot_types = ['float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','float64','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       voltage_input,temperature_pcb,current_motor,current_input,current_q,speed,duty_cycle,charge_drawn,charge_regen,energy_drawn,energy_regen,displacement,distance_traveled,fault_code
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_13di().pack(_x.voltage_input, _x.temperature_pcb, _x.current_motor, _x.current_input, _x.current_q, _x.speed, _x.duty_cycle, _x.charge_drawn, _x.charge_regen, _x.energy_drawn, _x.energy_regen, _x.displacement, _x.distance_traveled, _x.fault_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.voltage_input, _x.temperature_pcb, _x.current_motor, _x.current_input, _x.current_q, _x.speed, _x.duty_cycle, _x.charge_drawn, _x.charge_regen, _x.energy_drawn, _x.energy_regen, _x.displacement, _x.distance_traveled, _x.fault_code,) = _get_struct_13di().unpack(str[start:end])
      return self
