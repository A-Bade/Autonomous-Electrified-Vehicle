...
(cl:ensure-generic-function 'current_q-val :lambda-list '(m))
(cl:defmethod current_q-val ((m <VescState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vesc_msgs-msg:current_q-val is deprecated.  Use vesc_msgs-msg:current_q instead.")
  (current_q m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <VescState>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'current_input))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'current_q))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <VescState>) istream)
  "Deserializes a message object of type '<VescState>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'current_q) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VescState>)))
  ...
  "e6d0690b6e2b538a8d1d91e427b48761")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VescState)))
  "Returns md5sum for a message object of type 'VescState"
  "e6d0690b6e2b538a8d1d91e427b48761")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <VescState>))
  ...
  (cl:list 'VescState
    ...
    (cl:cons ':current_q (current_q msg))
