...
class VescState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('current_q')) {
        this.current_q = initObj.current_q
      }
      else {
        this.current_q = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [current_q]
    bufferOffset = _serializer.float64(obj.current_q, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [current_q]
    data.current_q = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.current_q !== undefined) {
      resolved.current_q = msg.current_q;
    }
    else {
      resolved.current_q = 0.0
    }
